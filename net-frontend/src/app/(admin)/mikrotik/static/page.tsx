...
import { StaticTableComponent } from "@/components/mikrotik/static/StaticTableComponent";
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">
            Kelola static binding pelanggan hotspot
          </p>
        </div>
        <div className="flex flex-wrap gap-2">
          <button
            onClick={() => router.push("/mikrotik/static/server")}
            className="inline-flex items-center gap-1.5 rounded-lg border border-orange-300 bg-orange-50 px-4 py-2 text-sm font-medium text-orange-700 hover:bg-orange-100 dark:border-orange-700 dark:bg-orange-900/30 dark:text-orange-300 dark:hover:bg-orange-900/50"
          >
      ...
      {selectedRouterId && selectedRouter ? (
        ...
        <div className="rounded-lg border border-gray-200 bg-gray-50 p-8 text-center dark:border-gray-800 dark:bg-gray-800/50">
          <p className="text-gray-500 dark:text-gray-400">
            Silakan pilih router aktif untuk melihat IP binding
          </p>
        </div>
      ) : null}
    </div>
