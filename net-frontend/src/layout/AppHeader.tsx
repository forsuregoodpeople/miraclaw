  ...
  return (
    <header className="flex w-full bg-white border-b border-gray-200 dark:border-gray-800 dark:bg-gray-900">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4 lg:w-auto lg:flex-1">
          <button
...
<button
        ...
        <div
          ...
          } items-center justify-between w-full gap-4 px-5 py-4 lg:flex lg:w-auto lg:justify-end lg:px-0 lg:py-4 lg:shadow-none shadow-theme-md`}
        >
